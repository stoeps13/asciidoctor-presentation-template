...
* MS Excel with Dropbox
* MS Word with Sharepoint or Mail
* Several Wiki engines
* Evernote (Linux client long time a problem, new license limits devices)
* Adding config with screenshots or copy & paste
* Latest with opening in other Office version or product with 100% compatibility -> layout or document broken
** sometimes switching printer is enough
